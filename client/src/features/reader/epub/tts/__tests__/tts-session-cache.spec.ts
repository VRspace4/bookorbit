...
describe('tts-session-cache', () => {
  ...
  it('writes and reads a playback session', () => {
    writeTtsPlaybackSession(42, { wasPlaying: true, sectionIndex: 3, wordIndex: 12 })
  ...
  it('clears a stored session', () => {
    writeTtsPlaybackSession(42, { wasPlaying: true, sectionIndex: 0, wordIndex: 0 })
  ...
  it('persists and clears the user-stopped flag in sessionStorage', () => {
